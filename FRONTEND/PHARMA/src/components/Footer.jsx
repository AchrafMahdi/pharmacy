                    ...
                    <div>
                        ...
                        <div class="mt-3 grid space-y-3 text-sm">
                            ...
                            <p>
                                ...
                                <span class="inline text-lime-600">
                                    — We're hiring
                                </span>
                            </p>
                            <p>
                    ...
                    <div>
                        ...
                        <div class="mt-3 grid space-y-3 text-sm">
                            ...
                            <p>
                                ...
                                <span class="inline text-lime-600">— New</span>
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-x-3">
                            ...
                            <div class="hs-dropdown [--placement:top-left] relative inline-flex">
                                ...
                                >
                                    ...
                                    English (US)
                                    <svg
                                        class="hs-dropdown-open:rotate-180 flex-shrink-0 size-4 text-gray-500"
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                                ...
                                >
                                    <a
                                        class="flex items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100"
                                        href="#"
                                    >
                                        <svg
